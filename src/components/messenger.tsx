...
export const Messenger: FC = ({ }): JSX.Element => {
    ...
    return (
        <div className={`fixed bottom-0 right-40 w-[25rem] ${popup ? "h-[50vh]" : "h-12"}  bg-white z-50 shadow-2xl`}>
            <header
                ...
                className="w-full h-12 bg-grey-light flex flex-row justify-evenly items-center shadow-lg"
            >
            ...
            {popup && (
                <form className="w-full bottom-0 absolute h-12" onSubmit={e => handleSubmit(e)}>
