      ...
      <HelpLayout>
        <div className="w-screen h-screen flex flex-col justify-start items-center">
          <div className="h-4/6 my-20 w-1/2 flex flex-col items-center justify-evenly">
            ...
            <p>
              Kleanse values self driven indiviuals and because of that we have decided to give power to the amazing influencers of todays
              social media platforms to convey our products.
            </p>
              ...
              <span className="flex flex-row items-start h-full w-full justify-evenly p-12">
                <Link href="https://www.facebook.com">
                  <span className="flex flex-row w-full items-center">
                    <Image alt="" src="/images/ui-elements/facebook-f-brands.svg" width={80} height={80} />
                    <p className="mx-3">Facebook</p>
                  </span>
                </Link>
                <Link href="https://www.twitter.com">
                  <span className="flex flex-row w-full items-center">
                    <Image alt="" src="/images/ui-elements/instagram-brands.svg" width={80} height={80} />
                    <p className="mx-3">Instagram</p>
                  </span>
                </Link>
                <Link href="https://www.instagram.com">
                  <span className="flex flex-row w-full items-center">
                    <Image alt="" src="/images/ui-elements/twitter-brands.svg" width={80} height={80} />
