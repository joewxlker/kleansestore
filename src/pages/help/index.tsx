    ...
    <>
      ...
      <Layout>
        <div id="hardfadein" className="flex flex-col justify-center items-center">
          ...
          <div
            className="flex flex-row items-start justify-center h-full w-auto border-b-3 border-b-black border-b m-8 mx-5 pb-12"
            style={{}}
          >
...
export const ContactFormComponent: FC = (): JSX.Element => {
  ...
  const Success: FC = (): JSX.Element => {
    return <div>Thank you for contacting kleanse</div>;
  };

  const Failed: FC = (): JSX.Element => {
    return <div>Unfortunatly your request was unnable to reach its destination, please try again.</div>;
  };
