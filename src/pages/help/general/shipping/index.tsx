      ...
      <HelpLayout>
        <div className="flex flex-col justify-start items-center h-screen  pt-18">
          ...
          <div className="w-screen h-4/6 flex flex-row justify-center items-start">
            <div className="my-20 w-1/2 h-4/6 flex flex-col items-center justify-start">
              ...
              <ul className="h-full flex flex-col justify-evenly items-center">
                <Link href="/help/general/shipping/tracking-orders">
                  <li className="p-2 cursor-pointer">Didn&apos;t receive a tracking order?</li>
                </Link>
          ...
          <span className="flex flex-col justify-center items-center">
            ...
            <button className="bg-grey px-4 py-3 text-white w-40" onClick={e => setContactForm(true)}>
              CONTACT US
            </button>
          </span>
          {contact && (
            <Layover>
              <div className="w-full h-full flex flex-col justify-start items-center">
                <header className="h-12 w-full flex flex-col items-end">
                  <button className="w-20 h-full flex items-center justify-center bg-grey text-white" onClick={e => setContactForm(false)}>
                    x
                  </button>
                </header>
