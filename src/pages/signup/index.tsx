...
const Signup: FC = ({ }): JSX.Element => {
  ...
  const Exists: FC = (): JSX.Element => {
    return (
      <div
        className="fixed top-0 left-0 flex w-screen h-screen z-10 flex-col justify-center items-center"
      ...
      >
        <div className="h-1/2 w-1/2 flex flex-col items-center justify-center bg-grey text-white">
          ...
          <button className="px-3 py-2 bg-grey text-white" onClick={() => signIn()}>
            Login
          </button>
        </div>
      </div>
